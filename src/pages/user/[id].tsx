...
export default function Me({ locale, user }: InferGetStaticPropsType<typeof getStaticProps>) {
    return (
      <main>
        ...
        <section className="w-full flex min-h-[50vh] justify-center items-center p-10">
          <article className="card w-1/2 bg-base-300">
            ...
            <Image className="absolute rounded-badge w-32 h-32 right-0 -translate-x-4 translate-y-4" src="/images/face.jpg" width={400} height={400} alt="profile picture"/>
